...
* Reads the file in a streaming way (does not load the full file into memory)
...
* A variable `in_quotes` is used to track whether the parser is inside a quoted field
...
This project helped me understand CSV file handling at a much deeper level than simply using the built-in library. Implementing the reader and writer manually gave practical experience with file I/O, parsing logic, and performance benchmarking, which are important skills for data engineering.
